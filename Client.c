...
// Muestra los diversos mensajes de error que pueden ocurrir y cierra el cliente0
...
int main(int argc, char * argv[]) {
	...
	// Se llamma a connect para realizar una coneccion con el server el segundo argumento es el server
	if(connect(idSocket, (struct sockaddr *) &dirServer, sizeof(dirServer)) < 0) {
